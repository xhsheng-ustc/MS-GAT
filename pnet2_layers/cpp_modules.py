...
sampling_module=tf.load_op_library('/ghome/shengxh/MS-GAT/code/main/tf_ops/sampling/tf_sampling_so.so')
grouping_module=tf.load_op_library('/ghome/shengxh/MS-GAT/code/main/tf_ops/grouping/tf_grouping_so.so')
interpolate_module=tf.load_op_library('/ghome/shengxh/MS-GAT/code/main/tf_ops/3d_interpolation/tf_interpolate_so.so')
